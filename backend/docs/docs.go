        ...
        "/upload-certificates": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.CareerCertification"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Certification file(s)",
                        "name": "files",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "Number of concurrent workers (default: 3, 0 = use default, max: 20)",
                        "name": "workers",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Issuer/Institution name",
                        "name": "issuer",
                        "in": "formData"
                    },
                    {
